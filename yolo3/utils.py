...
def get_random_data(annotation_line, input_shape, random=True, max_boxes=20, jitter=.3, hue=.1, sat=1.5, val=1.5, proc_img=True):
    ...
    path_start_end_inds = [i for i, ch in enumerate(annotation_line) if ch == "'"]
    path = annotation_line[path_start_end_inds[0]+1 : path_start_end_inds[1]]
    annotation_line = annotation_line[path_start_end_inds[1]+1:]
