...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', required=True,
                        metavar="path/to/pretrained/weights",
    ...
    print("Annotation path: ", args.annotations)
    print("Classes path: ", args.classes)
    print("Anchors path ", args.anchors)
    print("Log dir path: ", args.logs)
    print("Path to pretrained weights", args.weights)
    ...
    model = create_model(input_shape, anchors, num_classes,
        freeze_body=2, weights_path=args.weights) 
